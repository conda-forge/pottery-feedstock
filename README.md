...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pottery-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13303&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pottery-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pottery` can be installed with:

```
conda install pottery
```

It is possible to list all of the versions of `pottery` available on your platform with:
